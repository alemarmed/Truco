...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Product_discount'
        db.create_table('core_product_discount', (
        ...
        db.send_create_signal('core', ['Product_discount'])

        # Deleting field 'Place_has_product.offer'
        db.delete_column('core_place_has_product', 'offer_id')


    def backwards(self, orm):
        # Deleting model 'Product_discount'
        db.delete_table('core_product_discount')

        # Adding field 'Place_has_product.offer'
        db.add_column('core_place_has_product', 'offer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Offer'], null=True),
                      keep_default=False)
