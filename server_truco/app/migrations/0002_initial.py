...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'app', ['Manager'])

        # Adding model 'Store'
        db.create_table(u'app_store', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ...
        db.send_create_signal(u'app', ['Store'])

        # Adding M2M table for field owners on 'Store'
        db.create_table(u'app_store_owners', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('store', models.ForeignKey(orm[u'app.store'], null=False)),
            ('manager', models.ForeignKey(orm[u'app.manager'], null=False))
        ))
        db.create_unique(u'app_store_owners', ['store_id', 'manager_id'])
        ...
        db.create_table(u'app_product_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('product', models.ForeignKey(orm[u'app.product'], null=False)),
            ('category', models.ForeignKey(orm[u'app.category'], null=False))
        ))
        db.create_unique(u'app_product_categories', ['product_id', 'category_id'])

        # Adding M2M table for field tags on 'Product'
        db.create_table(u'app_product_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('product', models.ForeignKey(orm[u'app.product'], null=False)),
            ('tag', models.ForeignKey(orm[u'app.tag'], null=False))
        ))
        db.create_unique(u'app_product_tags', ['product_id', 'tag_id'])

        # Adding model 'Virtual_product'
        db.create_table(u'app_virtual_product', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True)),
        ...
        db.send_create_signal(u'app', ['Virtual_product'])

        # Adding M2M table for field tags on 'Virtual_product'
        db.create_table(u'app_virtual_product_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('virtual_product', models.ForeignKey(orm[u'app.virtual_product'], null=False)),
            ('tag', models.ForeignKey(orm[u'app.tag'], null=False))
        ))
        db.create_unique(u'app_virtual_product_tags', ['virtual_product_id', 'tag_id'])
        ...
        db.create_table(u'app_province', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ...
        db.send_create_signal(u'app', ['Province'])
        ...
        db.send_create_signal(u'app', ['List'])

        # Adding M2M table for field shared_with on 'List'
        db.create_table(u'app_list_shared_with', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('list', models.ForeignKey(orm[u'app.list'], null=False)),
            ('consumer', models.ForeignKey(orm[u'app.consumer'], null=False))
        ))
        db.create_unique(u'app_list_shared_with', ['list_id', 'consumer_id'])

        # Adding model 'List_item'
        db.create_table(u'app_list_item', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'app', ['List_item'])

        # Adding model 'Localization'
        db.create_table(u'app_localization', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'app', ['Localization'])
        ...
        db.create_table(u'app_place_has_product', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'app', ['Place_has_product'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'app_consumer')

        # Deleting model 'Manager'
        db.delete_table(u'app_manager')

        # Deleting model 'Store'
        db.delete_table(u'app_store')
        ...
        db.delete_table(u'app_virtual_product')
    ...
    models = {
        u'app.brand': {
            ...
            'property_of': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.Store']"})
        },
        u'app.category': {
        ...
        u'app.city': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'province': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.Province']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'app.consumer': {
            'Meta': {'object_name': 'Consumer', '_ormbases': [u'auth.User']},
        ...
        u'app.list': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'my_lists'", 'to': u"orm['app.Consumer']"}),
            'routed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'shared_with': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'shared_lists'", 'symmetrical': 'False', 'to': u"orm['app.Consumer']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'app.list_item': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent_list': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.List']"}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.Product']", 'null': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'vproduct': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.Virtual_product']", 'null': 'True'})
        },
        u'app.localization': {
            'Meta': {'object_name': 'Localization'},
            'address': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True'}),
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.City']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'store': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.Store']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'zip_code': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        u'app.manager': {
            'Meta': {'object_name': 'Manager', '_ormbases': [u'auth.User']},
            'birthday': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'app.place_has_product': {
            'Meta': {'object_name': 'Place_has_product'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'localization': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.Localization']"}),
            'offer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.Offer']", 'null': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.Product']"}),
        ...
        u'app.province': {
            ...
            'country': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.Country']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        ...
        u'app.store': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'owners': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['app.Manager']", 'symmetrical': 'False'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'app.tag': {
        ...
        u'app.virtual_product': {
            'Meta': {'object_name': 'Virtual_product'},
            'brand': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.Brand']"}),
            'categories': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.Category']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
