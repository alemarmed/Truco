...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Offer.name'
        db.alter_column('app_offer', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=256))

        # Changing field 'Offer.text'
        db.alter_column('app_offer', 'text', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Brand.property_of'
        db.alter_column('app_brand', 'property_of_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Store'], null=True))

        # Changing field 'Store.description'
        db.alter_column('app_store', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'List.description'
        db.alter_column('app_list', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Virtual_product.size_type'
        db.alter_column('app_virtual_product', 'size_type', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

        # Changing field 'Virtual_product.brand'
        db.alter_column('app_virtual_product', 'brand_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Brand'], null=True))

        # Changing field 'Product.size_type'
        db.alter_column('app_product', 'size_type', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

        # Changing field 'Product.brand'
        db.alter_column('app_product', 'brand_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Brand'], null=True))

    def backwards(self, orm):

        # Changing field 'Offer.name'
        db.alter_column('app_offer', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Offer.text'
        db.alter_column('app_offer', 'text', self.gf('django.db.models.fields.CharField')(default=None, max_length=256))

        # Changing field 'Brand.property_of'
        db.alter_column('app_brand', 'property_of_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['app.Store']))

        # Changing field 'Store.description'
        db.alter_column('app_store', 'description', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'List.description'
        db.alter_column('app_list', 'description', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Virtual_product.size_type'
        db.alter_column('app_virtual_product', 'size_type', self.gf('django.db.models.fields.CharField')(default='', max_length=2))

        # Changing field 'Virtual_product.brand'
        db.alter_column('app_virtual_product', 'brand_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['app.Brand']))

        # Changing field 'Product.size_type'
        db.alter_column('app_product', 'size_type', self.gf('django.db.models.fields.CharField')(default='', max_length=2))

        # Changing field 'Product.brand'
        db.alter_column('app_product', 'brand_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['app.Brand']))
